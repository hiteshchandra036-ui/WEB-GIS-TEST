...
map.getView().fit([6086253.555086, 797908.389019, 12118117.390524, 4716694.119645], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Population Map of India</h2>';
        return titleElement;
    })(),
